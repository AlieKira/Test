...
public abstract class FSMState
{
    ...
    public virtual void SetTargetPlayer(GameObject player)
    {
        targetPlayer = player;
    }

    public virtual void SetNavAgent(NavMeshAgent agent)
    {
        this.navAgent = agent;
    }

    //在进入当前状态之前，需要做的事情
    public virtual void DoBeforeEntering(GameObject targetPlayer) { }
